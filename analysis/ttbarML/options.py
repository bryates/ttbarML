...
def commonOptions():
    ...
    parser.add_argument("--cores", type=str, default='1', help="Number of cores");
    ...
    parser.add_argument("--feature_division", type=str, default="1", help="Comma-separated of WC in the sample (by order)")
